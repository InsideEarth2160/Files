...
"============================================"
[byte[]]$bytes = Get-Content Earth2160_NO_SSE.exe -AsByteStream -Raw
ApplyTextInputFixes_NO_SSE  -bytes $bytes
,$bytes |Set-Content Earth2160_NO_SSE.exe -AsByteStream Byte

""
"============================================"
"Patching Earth2160_SSE.exe"
"============================================"
[byte[]]$bytes2 = Get-Content Earth2160_SSE.exe -AsByteStream -Raw
ApplyTextInputFixes_SSE  -bytes $bytes2
,$bytes2 |Set-Content Earth2160_SSE.exe -AsByteStream Byte