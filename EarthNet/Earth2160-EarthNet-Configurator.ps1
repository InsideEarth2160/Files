...
# ICMP Firewall Rule for 10.21.60.0/24
$firewallRuleNameICMP = "EarthNet_Allow_ICMP_from_10.21.60.0/24"
...
else
{
    ...
    New-NetFirewallRule -DisplayName $firewallRuleNameICMP -Direction Inbound -Action Allow -Protocol ICMPv4 -RemoteAddress 10.21.60.0/24
...
ping vpnnetserver2160.insideearth.info
